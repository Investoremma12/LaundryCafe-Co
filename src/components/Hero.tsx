...
export default function Hero() {
	return (
		<section id="home" className="hero-shell">
			<div className="mx-auto grid max-w-310 grid-cols-1 items-center gap-10 px-6 py-16 md:min-h-[calc(100vh-73px)] md:grid-cols-[0.9fr_1.1fr] md:gap-14 md:px-8 md:py-20">
				<motion.div
